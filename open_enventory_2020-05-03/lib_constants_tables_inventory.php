...
$tables["molecule"]=array(
	...
	"fields" => array(
		...
		"Virendra" => array("type" => "DOUBLE", "search" => "auto"), //adding new column in molecule table
...
$tables["chemical_storage"]=array(
	...
	"fields" => array(
		...
		"history" => array("type" => "TEXT", ), // Eintragen von Entnahmen, nachträglich nicht mehr änderbar
